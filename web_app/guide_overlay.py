...
() => {
  const steps = [
    ...
    { target: '#balance-upload', title: 'Create the export used by this app', copy: 'Create a LEAP Energy Balance export in Petajoules at Detail Level 2 or deeper. This is the input the app reads to create the dashboard and, when you upload only one export, the review workbook. A Level 1 export does not contain enough detail. Upload several exports when you want dashboards for several economies or scenarios.', image: '__EXPORT_IMAGE__' },
